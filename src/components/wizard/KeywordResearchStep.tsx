...
const KeywordResearchStep: React.FC<KeywordResearchStepProps> = ({
  ...
  // Generate primary keywords when user clicks "Suggest" button
  ...
  // Generate secondary keywords when user clicks "Suggest" button
          ...
          <div className="mt-3">
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2 mt-1">
                ...
                >
                  {isGeneratingPrimary ? "Generating..." : "Regenerate"}
                </Button>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3">
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2 mt-1">
                ...
                >
                  {isGeneratingSecondary ? "Generating..." : "Regenerate"}
                </Button>
              </div>
            </div>
          </div>
