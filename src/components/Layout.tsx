  ...
  return (
    <div className="flex min-h-screen w-full bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col">
        <header className="h-16 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-6 bg-white dark:bg-gray-800 shadow-sm">
          ...
          <div className="hidden md:flex items-center max-w-md w-full mx-8">
            <div className="relative w-full">
              ...
              <Input 
                className="pl-10 pr-4 py-2 w-full bg-gray-50 dark:bg-gray-700 focus-visible:ring-gray-400" 
        ...
        {showHelp && (
          <div className="fixed bottom-6 right-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 w-[300px] z-50">
            <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
              <h3 className="font-medium dark:text-white">Help & Resources</h3>
            ...
            <div className="p-4 space-y-4">
              <a href="#" className="flex items-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition-colors">
                <FileText size={16} className="text-[#F76D01]" />
                <span className="dark:text-gray-200">Documentation</span>
              </a>
              <a href="#" className="flex items-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition-colors">
                <MessageSquare size={16} className="text-[#F76D01]" />
                <span className="dark:text-gray-200">Contact Support</span>
              </a>
              <a href="#" className="flex items-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition-colors">
                ...
                <span className="dark:text-gray-200">Tutorial Videos</span>
              </a>
              <a href="#" className="flex items-center gap-2 hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#F76D01]">
                ...
                <span className="dark:text-gray-200">GitHub Repository</span>
              </a>
            </div>
          </div>
        )}
...
const NotificationItem = ({ title, message, time, type }: NotificationItemProps) => {
  ...
  return (
    <div className="flex gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer">
      {getIconByType()}
