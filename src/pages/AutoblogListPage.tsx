      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex gap-3">
            ...
            <Button
              variant="default"
              className="bg-[#F76D01] hover:bg-[#e65d00] flex items-center gap-1"
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 uppercase text-xs font-medium text-gray-500">
                  <th className="text-left py-3 px-4">Name</th>
                  <th className="text-left py-3 px-4">Autoblog</th>
                  <th className="text-left py-3 px-4">Status</th>
                  <th className="text-left py-3 px-4">Next batch</th>
