...
const AutoblogConfigPage = () => {
  ...
  const handleUpdate = (field: string, value: any) => {
    ...
    switch (field) {
      // Basic Info
      case 'name': setCampaignName(value); break;
      case 'description': setCampaignDescription(value); break;
  ...
  const visibleSteps = wizardSteps.filter(step => 
    step.visibleFor === 'all' || step.visibleFor === 'autoblog'
  );
  ...
  return (
    <div className="w-full p-6 bg-gray-50">
      <h1 className="text-2xl font-bold mb-6">Configure Campaign: {campaignName}</h1>
